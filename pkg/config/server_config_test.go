...
func TestServerConfig(t *testing.T) {
	...
	if cfg.App.Mode != mode {
		t.Errorf("Mode '%v' doesn't match expected: %v", cfg.App.Mode, mode)
	}
...
func TestServerConfigDotEnv(t *testing.T) {
	...
	if cfg.App.Mode != mode {
		t.Errorf("DB user '%v' doesn't match expected: %v", cfg.App.Mode, mode)
	}
